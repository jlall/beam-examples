...
left = [{'Country': 'The Netherlands', 'Year': '2011',
...
def run(argv=None):
    ...
    source_data = p | 'Create source data' >> beam.Create(left)
    join_pipeline_name = 'join_data'
    join_data = p | 'Create join data' >> beam.Create(right)
    common_key = 'Country'
    ...
    #test_pipeline  | "print" >> beam.Map(collect)
